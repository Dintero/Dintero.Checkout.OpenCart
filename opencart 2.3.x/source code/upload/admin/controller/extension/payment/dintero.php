...
class ControllerExtensionPaymentDintero extends Controller {
	...
	public function index() {
		$trs = $this->load->language('extension/payment/dintero');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/dintero', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/dintero', 'token=' . $this->session->data['token'], true);
		...
		if (isset($this->request->post['dintero_status'])) {
			$data['dintero_status'] = $this->request->post['dintero_status'];
		} else {
			$data['dintero_status'] = $this->config->get('dintero_status');
		}
